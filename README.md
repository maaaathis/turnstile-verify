...
const remoteip = req.headers['CF-Connecting-IP'] || req.headers['x-forwarded-for'] || req.socket.remoteAddress; // optional
...
const turnstileResponse = await turnstile.validate({ response: cfTurnstileResponse, remoteip });
